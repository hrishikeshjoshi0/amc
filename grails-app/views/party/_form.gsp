<%@ page import="com.amcsoft.model.party.Party" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: partyInstance, field: 'addresses', 'error')} ">
				...
				<div class="controls">
					<g:select name="addresses" from="${com.amcsoft.model.party.Address.list()}" multiple="multiple" optionKey="id" size="5" required="" value="${partyInstance?.addresses*.id}" class="many-to-many"/>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: partyInstance, field: 'partyContactMechs', 'error')} ">
				...
				<div class="controls">
					<g:select name="partyContactMechs" from="${com.amcsoft.model.party.PartyContactMech.list()}" multiple="multiple" optionKey="id" size="5" required="" value="${partyInstance?.partyContactMechs*.id}" class="many-to-many"/>
